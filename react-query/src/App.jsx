...
export default function App() {
  return (
    <>
      ...
      <p>It simplifies data fetching, caching, synchronization, and more.</p>
      <h2>React Query</h2>
      <h4>React Query is a library for managing server state in React applications.</h4>
    <div className="flex items-center justify-center h-screen bg-amber-50">
      <div className="flex flex-col bg-amber-300 text-amber-50 rounded-2xl p-6 max-w-sm shadow-lg">
        <div className="flex flex-col items-center">
          ...
          />
          <h2 className="text-xl font-semibold mt-3">Fira</h2>
        </div>
        <div className="mt-4 text-center">
          <p className="text-sm mb-4">
            This is the challenge from ChatGPT. I finally finished it!nnnananananana
          </p>
